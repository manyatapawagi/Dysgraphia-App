...
if (localStorage.getItem("points") === null) {
    ...
    previous_points = localStorage.getItem("points");
    document.querySelector("#points").innerHTML += previous_points;
  }
else {
    previous_points = localStorage.getItem("points");
    document.querySelector("#points").innerHTML = "<img src='images/points.png'>" + previous_points;
}
            ...
            .then((url) => {
                ...
                fetch('http://127.0.0.1:5000/uploaded', {
                    ...
                    .then(function (response) {
                        document.querySelector("#uploading").innerHTML = "Uploaded";
                    ...
                    .then(
                        function (text) {
                            ...
                            var new_points = Number(points) + Number(previous_points);
                            localStorage.setItem("points", new_points);
                            document.querySelector("#result").innerHTML += "<br>Neatness: " + JSON.stringify(deviationAvPercentage) + "% <br>" + "Handwriting: " + JSON.stringify(overallConf) + "% <br>" + "Overall Score: " + JSON.stringify(overallScore) + "% <br>" + "points scored: " + points + "<br><button class='button' id='send' onclick='displayPoints()'><p>HOME</p></button>";
                            document.querySelector("#points").innerHTML = "<img src='images/points.png'>" + localStorage.getItem("points")
                            plotGraph(text);
